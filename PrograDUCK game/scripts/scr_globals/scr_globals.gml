...
//SELETOR DE NIVEIS
global.levels = [1,0,0,1,1] // 0 = bloqueada, 1 = liberada
global.levels_completed = [1,1,1,1, 0]; // 0 = não completada, 1 = completada

//DUCK DATA
global.totalbites = 0;
global.rainbowduck = 0;
